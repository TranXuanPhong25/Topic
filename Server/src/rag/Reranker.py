...
if __name__ == "__main__":
    ...
    sample_docs = [
        Document(
            page_content="Psoriasis is a chronic autoimmune skin condition that causes rapid skin cell buildup, resulting in scaling on the skin's surface.",
        ...
        Document(
            page_content="Atopic dermatitis, also known as eczema, is a condition that makes skin red and itchy. It's common in children but can occur at any age.",
            metadata={"source": "medical_textbook.pdf", "page": 38}
        ),
        Document(
            page_content="Herpes zoster, commonly known as shingles, is a viral infection that causes a painful rash.",
            metadata={"source": "medical_textbook.pdf", "page": 51}
        ),
    ]
    ...
    if reranker.ranker:
        # Test query
        query = "What are autoimmune skin conditions?"
        ...
        # Rerank with scores
        reranked = reranker.rerank_with_scores(query, sample_docs, top_k=3)
        ...
        print("❌ Reranker not available. Please install flashrank:")
